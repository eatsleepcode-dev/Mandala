...
import { emptySchedule, type WeeklySchedule } from '../../services/thermostatService';
...
describe('weeklyBands', () => {
  ...
  it('tags each band with its slot owner so drag-to-edit can find it', () => {
    ...
    // Monday wrap-in band (00:00–08:00) is owned by the LAST event of the
    // cyclic week (Monday's 18:00 Suspend, idx 1) — not by anything on Monday
